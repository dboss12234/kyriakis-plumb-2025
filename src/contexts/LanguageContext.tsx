...
const translations: Translations = {
  ...
  // Pricing Page
  'pricing.badge': 'Διαφανείς Τιμές',
  'pricing.title1': 'Τιμοκατάλογος',
  'pricing.title2': 'Υδραυλικών Εργασιών',
  'pricing.subtitle': 'Διαφανείς τιμές για όλες τις υδραυλικές υπηρεσίες. Χωρίς κρυφές χρεώσεις.',
  'pricing.estimate': 'Δωρεάν Προσφορά',
  'pricing.note.title': 'Σημαντική Σημείωση',
  'pricing.note.desc': 'Οι τιμές είναι ενδεικτικές και μπορεί να διαφέρουν ανάλογα με την πολυπλοκότητα της εργασίας και τα απαιτούμενα υλικά. Επικοινωνήστε μαζί μας για ακριβή προσφορά προσαρμοσμένη στις ανάγκες σας.',
  'pricing.cta.title1': 'Χρειάζεστε',
  'pricing.cta.title2': 'Μια Ακριβή Προσφορά;',
  'pricing.cta.subtitle': 'Επικοινωνήστε μαζί μας σήμερα για δωρεάν συμβουλευτική και προσφορά προσαρμοσμένη στις ανάγκες σας',
